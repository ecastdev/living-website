...
import { ContactMail, ContactMailTwoTone, EmailTwoTone, Key, LocationSearchingTwoTone, SocialDistance, WhatsApp, WhatshotTwoTone } from "@mui/icons-material"
        ...
        <div className="grid w-full justify-between items-center sm:flex sm:justify-between md:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link href="#" className='text-white font-light'><WhatsApp color="primary"/>   +265 99860676</Footer.Link>
                <Footer.Link href="#" className='text-white font-light'> <ContactMailTwoTone  color="primary"/> livingwordofgod@gmail.com</Footer.Link>
              </Footer.LinkGroup>
            </div>
          </div>
        </div>
